...
>>>>>>> 082434ae7aab5ca6506ada68746949be10e58904
...
<<<<<<< HEAD
				...
				<div class="header-btns">
					<a href="./colorlib-regform-5/register_user.php" class="site-btn sb-c1">Availibility </a>
					<a href="./Login_v1/login.php" class="site-btn sb-c2">Login</a>
					<a href="./colorlib-regform-3/register.php" class="site-btn sb-c3">Register</a>
=======
	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="img/bg.jpg">
				<div class="container">
<<<<<<< HEAD
					<h2>The FOOD Samaritan </h2>
					<p>Serving as the ROBIN"FOOD" of the VIRTUAL world,we provide the food from those who have suffice,to those who suffer. </p>
					<p>Our motto is: Serve God by Serving Food</p>
=======
